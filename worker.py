...
class Worker:
    ...
    def analyze_groups(self):
        ...
        for l_ind,label in enumerate(labels_unique):
            ...
            cg.find_dwarfs(self.dwarf_limit)
    ...
    def save(self):
        ...
        for filename,group in zip(filenames,groups):
            ...
            fmt_row = "{0:>16}, {1:>15}, {2:>9.5f}, {3:>9.5f}, {4:>9.5f}, {5:>12.5f}, {6:>12.5f}, {7:>12.5f}, {8:>12.5f}, {9:>9.5f}, {10:>12.5f}, {11:>11.5f}, {12:>15d}, {13:>8}, {14:>8}\n"
